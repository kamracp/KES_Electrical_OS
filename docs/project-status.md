...
- PRIORITY - Study form drafts survive a reload and navigation: the founder lost a filled form twice during the
  2026-09-26 smoke. Next slice. Related: F12 (session end while a form is half filled).
...
6. **Next:** the PRIORITY follow-up (study form drafts survive reload and navigation), then **EOS-03b DG**.
